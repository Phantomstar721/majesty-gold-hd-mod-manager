function Get-MajestyBuildProfiles {
    return @(
        ...
        [pscustomobject]@{
            ...
            ZoomConstructorCallVa = 0x5F2356
            ZoomConstructorCallOffset = 0x1F1756
            ZoomVtableEntryVa = 0x762218
            ZoomVtableEntryOffset = 0x361618
            ZoomRuntimeVtableEntryVa = 0x753930
            ZoomRuntimeVtableEntryOffset = 0x352D30
            ZoomSetterVa = 0x5F1FA0
            FopenIat = 0x74D458
            FreadIat = 0x74D45C
            FwriteIat = 0x74D460
            FcloseIat = 0x74D46C
            OriginalConstructorCallBytes = [byte[]]@(0xE8, 0x45, 0xFC, 0xFF, 0xFF)
            OriginalVtableEntryBytes = [byte[]]@(0xA0,0x1F,0x5F,0x00)
            OriginalRuntimeVtableEntryBytes = [byte[]]@(0xA0,0x1F,0x5F,0x00)
            SupportsLegacyTwoHookRestore = $false
        }
    )
}
