function Get-MajestyBuildProfiles {
    return @(
        ...
        [pscustomobject]@{
            ...
            BaseSections = @(
                @(".text", 0x1000, 0x400, 0x34C000, 0x34BEFD),
                @(".rdata", 0x34D000, 0x34C400, 0x84400, 0x843F8),
                @(".data", 0x3D2000, 0x3D0800, 0xD400, 0x5908C),
                @(".rsrc", 0x42C000, 0x3DDC00, 0x1000, 0xF34)
            )
            SpeedSliderSaveVa = 0x46C138; SpeedSliderSaveOffset = 0x6B538
            SpeedStepSlowerVa = 0x465443; SpeedStepSlowerOffset = 0x64843
            SpeedStepFasterVa = 0x4654E5; SpeedStepFasterOffset = 0x648E5
            SpeedRestoreOneVa = 0x4D9E25; SpeedRestoreOneOffset = 0xD9225
            SpeedRestoreTwoVa = 0x4DA829; SpeedRestoreTwoOffset = 0xD9C29
            SpeedCopyOneVa = 0x46B224; SpeedCopyOneOffset = 0x6A624
            SpeedCopyTwoVa = 0x46B369; SpeedCopyTwoOffset = 0x6A769
            SpeedObjectInitOneVa = 0x47C2FB; SpeedObjectInitOneOffset = 0x7B6FB
            SpeedObjectInitTwoVa = 0x429E32; SpeedObjectInitTwoOffset = 0x29232
            SpeedObjectInitThreeVa = 0x429E45; SpeedObjectInitThreeOffset = 0x29245
            OriginalSliderSaveBytes = [byte[]]@(0xA3, 0x04, 0x33, 0x7D, 0x00)
            OriginalRestoreBytes = [byte[]]@(0xA3, 0x04, 0x33, 0x7D, 0x00)
            OriginalCopyOneBytes = [byte[]]@(0x89, 0x15, 0x04, 0x33, 0x7D, 0x00)
            OriginalCopyTwoBytes = [byte[]]@(0x89, 0x0D, 0x04, 0x33, 0x7D, 0x00)
            ...
            GetGameVa = 0x4D88E0
            GameSpeedVa = 0x7D3304
            FopenIat = 0x74D458; FreadIat = 0x74D45C; FwriteIat = 0x74D460; FcloseIat = 0x74D46C
            SupportsLegacyHooks = $false
            OldOptionsSaveVa = 0; OldOptionsSaveOffset = 0
            OldOptionsRestoreVa = 0; OldOptionsRestoreOffset = 0
            OriginalOptionsSaveBytes = [byte[]]@()
