...
$preferenceDir = if ($PreferenceDirectory) { [IO.Path]::GetFullPath($PreferenceDirectory) } else {
    Join-Path ([Environment]::GetFolderPath([Environment+SpecialFolder]::LocalApplicationData)) "MajestyHD"
}
