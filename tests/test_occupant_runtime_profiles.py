...
class OccupantRuntimeProfileTests(unittest.TestCase):
    def verify(self, variable, name, timestamp, submit, slots, list_setup, list_refresh, list_callback, painter):
        ...
        cost, submit_call, action, dispatch, string_ctor, vtable = [int(x, 16) for x in re.findall(r"0x[0-9A-Fa-f]+", body)]
    ...
    def test_public(self):
        self.verify("MAJESTY_PUBLIC_EXE", "kPublicOccupants", 0x5897B72F, 0xC4CF0,
                    (0xBC2E0, 0xBC180, 0xBC0C0, 0xBBD90, 0xBC340, 0xBC1D0),
                    0x98EA0, 0x97E20, 0x98C60, 0x98360)

    def test_beta2(self):
        self.verify("MAJESTY_BETA2_EXE", "kBeta2Occupants", 0x5A8A11D5, 0xC5730,
